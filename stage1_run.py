...
from modules.generator import OcclusionAwareGenerator, BaseOcclusionAwareSPADEGenerator
...
if __name__ == "__main__":
    ...
    if opt.gen == 'original':
        ...
        generator = BaseOcclusionAwareSPADEGenerator(**config['model_params']['generator_params'],
                                                 **config['model_params']['common_params'])
